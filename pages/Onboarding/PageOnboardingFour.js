...
const handlePressNext = () => {
  ...
  return (
    ...
    <View style={styles.dotsContainer}>
      ...
      <Text style={styles.subTitle}>Veja seu desenvolvimento em tempo real! Nosso painel de progresso permite que você visualize o andamento dos cursos e se mantenha no caminho certo para alcançar seus objetivos.</Text>
